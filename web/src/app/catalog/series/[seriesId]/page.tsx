...
export default async function SeriesDetailPage({ params }: { params: Promise<{ seriesId: string }> }) {
  ...
  const [seasonMetadataResult, episodeMetadataResult] = await Promise.all([
