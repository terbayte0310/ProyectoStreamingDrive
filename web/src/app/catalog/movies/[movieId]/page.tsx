...
export default async function MovieDetailPage({ params }: { params: Promise<{ movieId: string }> }) {
  ...
  const [modulesResult, movieResult, metadataResult] = await Promise.all([
